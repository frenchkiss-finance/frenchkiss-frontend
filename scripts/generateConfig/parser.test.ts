  ...
  const inputFarm = [
    {
      ...
      pid: 0,
      lp_symbol: 'KISS',
      lp_mainnet_address: '0x3b44b0cFe3a290906F3C6479df56457db9d7cd59',
      token: {
        _id: '5ffd7e79361bff0009cc8189',
        decimals: 18,
        name: 'GLOSS',
        symbol: 'GLOSS',
        mainnet_address: '0x3b44b0cFe3a290906F3C6479df56457db9d7cd59',
    ...
    const outPut = [
      {
        pid: 0,
        lpSymbol: 'KISS',
        lpAddresses: '0x3b44b0cFe3a290906F3C6479df56457db9d7cd59',
        tokenSymbol: 'GLOSS',
        tokenAddresses: '0x3b44b0cFe3a290906F3C6479df56457db9d7cd59',
