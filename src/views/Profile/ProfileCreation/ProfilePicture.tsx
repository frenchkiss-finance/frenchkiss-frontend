...
import { AutoRenewIcon, Button, Card, CardBody, Heading, Skeleton, Text } from '@frenchkiss-libs/uikit'
...
import { useFrenchkissRabbits } from 'hooks/useContract'
...
const ProfilePicture: React.FC = () => {
  ...
  const handleApprove = () => {
    frenchkissRabbitsContract.methods
      .approve(getFrenchkissProfileAddress(), tokenId)
      .send({ from: account })
      .on('sending', () => {
        setIsApproving(true)
      })
    ...
    return (
      <>
        ...
        <Text bold fontSize="20px" mb="24px">
          {TranslateString(854, 'We couldn’t find any FrenchKiss Collectibles in your wallet.')}
        </Text>
        <Text as="p">
          {TranslateString(
            856,
            'You need a FrenchKiss Collectible to finish setting up your profile. If you sold or transferred your starter collectible to another wallet, you’ll need to get it back or acquire a new one somehow. You can’t make a new starter with this wallet address.',
          )}
        </Text>
      </>
    )
      ...
      <Card mb="24px">
        <CardBody>
          ...
          <Text as="p" color="textSubtle" mb="24px">
            {TranslateString(816, 'Only approved FrenchKiss Collectibles can be used.')}
