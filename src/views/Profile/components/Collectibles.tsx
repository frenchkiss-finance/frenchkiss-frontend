...
import { Heading, Text, Flex, ChevronRightIcon } from '@frenchkiss-libs/uikit'
  ...
  return (
    <>
      <Heading as="h4" size="md" mb="8px">
        {TranslateString(999, 'FrenchKiss Collectibles')}
      </Heading>
      <Text as="p">
        {TranslateString(
          999,
          'FrenchKiss Collectibles are special ERC-721 NFTs that can be used on the FrenchKiss Finance platform.',
        )}
      </Text>
      <Text as="p">
        {TranslateString(
          999,
          "NFTs in this user's wallet that aren't approved FrenchKiss Collectibles won't be shown here.",
        )}
      </Text>
      ...
      <Flex alignItems="center" justifyContent="flex-end">
        <Link to="/collectibles">{TranslateString(999, 'See all approved FrenchKiss Collectibles')}</Link>
        <ChevronRightIcon />
      </Flex>
    </>
  )
