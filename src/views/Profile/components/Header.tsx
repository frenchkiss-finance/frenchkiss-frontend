...
import { Button, Flex, Heading, useModal, Won } from '@frenchkiss-libs/uikit'
import { useProfile } from 'state/hooks'
import useI18n from 'hooks/useI18n'
import ClaimNftAndKissModal, { useCanClaim } from './ClaimGiftModal'
...
const ProfileHeader = () => {
  ...
  const [onPresentClaimGiftModal] = useModal(<ClaimNftAndKissModal onSuccess={checkClaimStatus} />)
