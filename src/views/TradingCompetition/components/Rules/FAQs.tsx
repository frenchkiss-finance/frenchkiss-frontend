...
import { Card, CardBody, CardHeader, Heading, Text, Flex } from '@frenchkiss-libs/uikit'
        ...
        <StyledCardbody>
          <FoldableText title={TranslateString(999, 'Eligible trading pairs')} mt="24px">
            <Text fontSize="14px" color="textSubtle">
              {TranslateString(
                999,
                'Only trades on BNB/BUSD, KISS/BNB, ETH/BNB and BTCB/BNB pairs will be included in volume calculations.',
              )}
            </Text>
          </FoldableText>
          ...
          <FoldableText title={TranslateString(999, 'Prize distribution')} mt="24px">
            <Text fontSize="14px" color="textSubtle">
              ...
              {TranslateString(
                999,
                'Prizes to be distributed in KISS and shared by all members of each respective tier as per the Prizes section above.',
              )}
            </Text>
            <Text fontSize="14px" color="textSubtle">
              -{' '}
              {TranslateString(
                999,
                'KISS prizes will be distributed as per the KISS/BUSD price on the day of distribution. Every eligible participant will win prizes at the end of the competition.',
              )}
            </Text>
            <Text fontSize="14px" color="textSubtle">
          ...
          <FoldableText title={TranslateString(999, 'Fine print')} mt="24px">
            <Text fontSize="14px" color="textSubtle">
              ...
              {TranslateString(
                999,
                'In the event of a disagreement concerning the final winning team or rank, FrenchKiss Finance will have the final say.',
              )}
            </Text>
            <Text fontSize="14px" color="textSubtle">
              -{' '}
              {TranslateString(
                999,
                'FrenchKiss Finance can and will disqualify any team or specific members that are proven to have taken malicious action or attempt to “cheat” in any way.',
              )}
            </Text>
          </FoldableText>
