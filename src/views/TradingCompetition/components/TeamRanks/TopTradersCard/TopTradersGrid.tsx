...
import { Box, Skeleton } from '@frenchkiss-libs/uikit'
import styled from 'styled-components'
import { LeaderboardDataItem } from '../../../types'
import GridItem from './GridItem'
import ExpandedGridItem from './ExpandedGridItem'
import { LeaderboardStorm, LeaderboardFlippers, LeaderboardKissers } from '../../../svgs'
...
const TopTradersGrid: React.FC<{ data?: LeaderboardDataItem[]; isExpanded: boolean }> = ({ data, isExpanded }) => {
  ...
  const teamImages = [<LeaderboardStorm />, <LeaderboardFlippers />, <LeaderboardKissers />]
