...
import { Flex, Text, Heading, Link } from '@frenchkiss-libs/uikit'
    ...
    <Flex flexDirection="column" maxWidth="736px">
      ...
      <HowToCard number={1} title={TranslateString(999, 'Get Ready')}>
        <Text fontSize="14px" color="textSubtle">
          ...
          <StyledLink href="/profile">{TranslateString(999, 'FrenchKiss Profile')}</StyledLink>
          {', '}
      ...
      <HowToCard number={2} title={TranslateString(999, 'Battle Time')}>
        <Text fontSize="14px" color="textSubtle">
          {TranslateString(
            999,
            'Trade BNB/BUSD, KISS/BNB, ETH/BNB and BTCB/BNB during the battle period to raise both your and your team’s score. See the Rules section below for more.',
          )}
        </Text>
      </HowToCard>
