...
import { Flex, Box, Image } from '@frenchkiss-libs/uikit'
...
const TradingCompetition = () => {
  ...
  const { hasUserClaimed, userKissRewards, userPointReward, canClaimNFT } = userTradingInformation

  const userCanClaimPrizes =
    currentPhase.state === CLAIM &&
    !hasUserClaimed &&
    (userKissRewards !== '0' || userPointReward !== '0' || canClaimNFT)
