...
import { Button, IconButton, useModal, AddIcon, Image } from '@frenchkiss-libs/uikit'
...
import OldGlossTitle from './OldGlossTitle'
...
const PoolCard: React.FC<HarvestProps> = ({ pool }) => {
  ...
  const isOldGloss = stakingToken.symbol === tokens.gloss.symbol
