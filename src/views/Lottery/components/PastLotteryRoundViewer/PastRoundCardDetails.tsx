...
import { Heading, CardBody, CardFooter, FrenchkissRoundIcon, TicketRound } from '@frenchkiss-libs/uikit'
      ...
      <>
        <CardBody>
          <CardHeading>
            ...
            <LotteryCardHeading
              valueToDisplay={TranslateString(999, `${poolSize.toLocaleString()} KISS`)}
              Icon={FrenchkissRoundIcon}
            >
