...
import { Heading, Card, CardBody, CardFooter, Text, FrenchkissRoundIcon, Flex, Skeleton } from '@frenchkiss-libs/uikit'
...
const TotalPrizesCard = () => {
  ...
  const lotteryPrizeAmountBusd = new BigNumber(lotteryPrizeAmount).multipliedBy(usePriceKissBusd()).toNumber()
        ...
        <CardHeading>
          <Left>
            ...
            <PrizeCountWrapper>
              ...
              <Heading size="lg">{lotteryPrizeWithCommaSeparators} KISS</Heading>
