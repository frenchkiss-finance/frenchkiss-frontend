    ...
    switch (step) {
        ...
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small mb="16px">
              You’ll need an active FrenchKiss Finance Profile to take part in an IFO!
            </Text>
            {isStepValid ? (
      ...
      case 1:
        return (
          <CardBody>
            <Heading as="h4" color="secondary" mb="16px">
              Get KISS-BNB LP Tokens
            </Heading>
            <Text color="textSubtle" small>
              Stake KISS and BNB in the liquidity pool to get LP tokens. <br />
      ...
      case 3:
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small>
              After the IFO sales finish, you can claim any IFO tokens that you bought, and any unspent KISS-BNB LP
