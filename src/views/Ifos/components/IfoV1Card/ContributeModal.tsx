...
import { Modal, LinkExternal, Box, Text } from '@frenchkiss-libs/uikit'
  ...
  return (
    <Modal title={`Contribute ${currency}`} onDismiss={onDismiss}>
      <Box maxWidth="400px">
        ...
        />
        <LinkExternal
          href="https://exchange.frenchkiss.finance/#/add/BNB/0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82"
