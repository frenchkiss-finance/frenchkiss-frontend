...
import { Box, Button, Flex, Text, useModal } from '@frenchkiss-libs/uikit'
...
const Contribute: React.FC<ContributeProps> = ({
  ...
  const handleContributeSuccess = (amount: BigNumber) => {
    toastSuccess('Success!', `You have contributed ${getBalanceNumber(amount)} KISS-BNB LP tokens to this IFO!`)
