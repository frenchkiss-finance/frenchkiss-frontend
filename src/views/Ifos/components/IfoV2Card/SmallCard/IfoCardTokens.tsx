...
import { Text, Flex, Box, Image, CheckmarkCircleIcon, FlexProps, HelpIcon, useTooltip } from '@frenchkiss-libs/uikit'
...
const IfoCardTokens: React.FC<IfoCardTokensProps> = ({
  ...
  const renderTokenSection = () => {
    ...
    if (account && !hasProfile) {
      return (
        <Text textAlign="center">
          {TranslateString(999, 'You need an active FrenchKiss Finance Profile to take part in an IFO!')}
        </Text>
      )
    }
    ...
    if (publicIfoData.status === 'live') {
      return (
        <>
          <TokenSection img="/images/farms/kiss-bnb.svg" mb="24px">
