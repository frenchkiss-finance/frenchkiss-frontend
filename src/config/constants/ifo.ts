import tokens from './tokens.old'
import farms from './farms'
import { Ifo, Token } from './types'

const kissBnbLpToken: Token = {
...
const ifos: Ifo[] = [
  {
    ...
    currency: kissBnbLpToken,
    token: tokens.hzn,
    releaseBlockNumber: 6581111,
    campaignId: '511090000',
    articleUrl: 'https://frenchkiss-finance.medium.com/horizon-protocol-hzn-ifo-to-be-hosted-on-pancakeswap-51f79601c9d8',
  ...
  },
  {
    ...
    kissToBurn: '$1,500,000',
    projectSiteUrl: 'https://beta.belt.fi/',
    currency: kissBnbLpToken,
    token: tokens.belt,
    releaseBlockNumber: 5493919,
    campaignId: '511080000',
    articleUrl: 'https://frenchkiss-finance.medium.com/belt-fi-belt-ifo-to-be-hosted-on-pancakeswap-353585117e32',
    isV1: true,
  },
  {
    id: 'watch',
    ...
    articleUrl: 'https://frenchkiss-finance.medium.com/yieldwatch-watch-ifo-to-be-hosted-on-pancakeswap-d24301f17241',
    isV1: true,
  },
  {
    id: 'berry',
    ...
    articleUrl: 'https://frenchkiss-finance.medium.com/berry-bry-ifo-to-be-hosted-on-pancakeswap-b4f9095e9cdb',
    isV1: true,
  },
  {
    id: 'soteria',
    ...
    articleUrl: 'https://frenchkiss-finance.medium.com/soteria-sota-ifo-to-be-hosted-on-pancakeswap-64b727c272ae',
    isV1: true,
  },
  {
    id: 'helmet',
    ...
    articleUrl: 'https://frenchkiss-finance.medium.com/1-000-000-helmet-helmet-ifo-to-be-hosted-on-pancakeswap-3379a2a89a67',
    isV1: true,
  },
  {
    id: 'tenet',
    ...
    articleUrl: 'https://frenchkiss-finance.medium.com/tenet-ten-ifo-to-be-hosted-on-pancakeswap-b7e1eb4cb272',
    isV1: true,
  },
  {
    id: 'ditto',
    ...
    articleUrl: 'https://frenchkiss-finance.medium.com/ditto-money-ditto-ifo-to-be-hosted-on-pancakeswap-342da3059a66',
    isV1: true,
  },
  {
    id: 'blink',
