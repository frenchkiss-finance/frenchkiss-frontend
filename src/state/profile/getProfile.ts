...
import { getProfileContract, getFrenchkissRabbitContract } from 'utils/contractHelpers'
...
const rabbitContract = getFrenchkissRabbitContract()
  ...
  try {
    ...
    if (isActive) {
      ...
      Cookies.set(
        ...
        {
          username,
          avatar: `https://frenchkiss.finance/images/nfts/${nft.images.sm}`,
        },
        { domain: 'frenchkiss.finance', secure: true, expires: 30 },
      )
    }
