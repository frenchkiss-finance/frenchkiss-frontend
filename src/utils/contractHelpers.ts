...
import {
  getAddress,
  getFrenchkissProfileAddress,
  getFrenchkissRabbitsAddress,
...
// ABI
import profileABI from 'config/abi/frenchkissProfile.json'
import frenchkissRabbitsAbi from 'config/abi/frenchkissRabbits.json'
...
export const getProfileContract = (web3?: Web3) => {
  return getContract(profileABI, getFrenchkissProfileAddress(), web3)
}
export const getFrenchkissRabbitContract = (web3?: Web3) => {
  return getContract(frenchkissRabbitsAbi, getFrenchkissRabbitsAddress(), web3)
}
